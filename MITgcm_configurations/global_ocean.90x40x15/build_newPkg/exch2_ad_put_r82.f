...
CBOP 0
C !ROUTINE: EXCH2_AD_PUT_R82

C !INTERFACE:
      SUBROUTINE EXCH2_AD_PUT_R82 (
...
C     myThid        :: my Thread Id. number
      ...
      Real*8     e2Bufr1_R8( e2BufrRecSize )
      Real*8     e2Bufr2_R8( e2BufrRecSize )
...
C     Ran off end of buffer. This should not happen
        WRITE(msgBuf,'(2A,I9,A,I9)') 'EXCH2_AD_PUT_R82:',
     &   ' iBufr1=', iBufr1, ' exceeds E2BUFR size=', e2BufrRecSize
        CALL PRINT_ERROR ( msgBuf, myThid )
        STOP 'ABNORMAL END: S/R EXCH2_AD_PUT_R82 (iBufr1 over limit)'
      ENDIF
...
C     Ran off end of buffer. This should not happen
     ...
     &   ' iBufr2=', iBufr2, ' exceeds E2BUFR size=', e2BufrRecSize
        CALL PRINT_ERROR ( msgBuf, myThid )
        STOP 'ABNORMAL END: S/R EXCH2_AD_PUT_R82 (iBufr2 over limit)'
      ENDIF
