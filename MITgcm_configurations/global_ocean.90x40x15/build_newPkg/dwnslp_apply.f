...
C     dwnslp_drFlow :: max. thickness [m] of the effective downsloping flow layer
     ...
     &        DWNSLP_slope, DWNSLP_rec_mu, DWNSLP_drFlow
      Real*8     DWNSLP_slope, DWNSLP_rec_mu, DWNSLP_drFlow
...
C     myThid     :: my Thread Id. number
      ...
      Real*8 tracer      ( xySize, Nr )
      Real*8 gTracer     ( xySize, Nr )
      Real*8 recip_hFac  ( xySize, Nr )
      Real*8 recip_rA_arg( xySize, nSx, nSy )
      Real*8 recip_drF(Nr)
      Real*8 deltaTLev(Nr)
      Real*8     myTime
