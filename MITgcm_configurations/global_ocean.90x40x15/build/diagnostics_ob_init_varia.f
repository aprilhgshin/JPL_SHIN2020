...
C     3-dim.
        DO k=1,Nr
         DO j=1-Oly,sNy+OLy
          DO i=1-Olx,sNx+Olx
           diagOB_StatScal1(i,j,k,bi,bj) = 0.D0
           diagOB_StatScal2(i,j,k,bi,bj) = 0.D0
           diagOB_StatVelU (i,j,k,bi,bj) = 0.D0
           diagOB_StatVelV (i,j,k,bi,bj) = 0.D0
           diagOB_TendScal1(i,j,k,bi,bj) = 0.D0
           diagOB_TendScal2(i,j,k,bi,bj) = 0.D0
           diagOB_TendVelU (i,j,k,bi,bj) = 0.D0
           diagOB_TendVelV (i,j,k,bi,bj) = 0.D0
          ENDDO
         ENDDO
        ENDDO
...
C     2-dim.
        DO j=1-Oly,sNy+OLy
         DO i=1-Olx,sNx+Olx
          diagOB_Surf1(i,j,bi,bj) = 0.D0
          diagOB_Surf2(i,j,bi,bj) = 0.D0
         ENDDO
        ENDDO
