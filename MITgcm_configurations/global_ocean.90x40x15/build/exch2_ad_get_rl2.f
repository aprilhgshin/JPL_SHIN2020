...
CBOP 0
C !ROUTINE: EXCH2_AD_GET_RL2

C !INTERFACE:
      SUBROUTINE EXCH2_AD_GET_RL2 (
...
C     e2BufrRecSize :: Number of elements in each entry of e2Bufr[1,2]Real*8
...
C     myThid        :: my Thread Id. number
      ...
      Real*8     e2Bufr1_RL( e2BufrRecSize, sizeNb, sizeBi, sizeBj, 2 )
      Real*8     e2Bufr2_RL( e2BufrRecSize, sizeNb, sizeBi, sizeBj, 2 )
      Real*8     array1(i1Lo:i1Hi,j1Lo:j1Hi,k1Lo:k1Hi)
      Real*8     array2(i2Lo:i2Hi,j2Lo:j2Hi,k2Lo:k2Hi)
...
C      this source tile Id "soT" (note: this is saved in W2_tileIndex array)
      ...
      ELSEIF ( commSetting .EQ. 'M' ) THEN
       ...
       sNb = nN
      ELSE
       STOP 'EXCH2_AD_GET_RL2:: commSetting VALUE IS INVALID'
      ENDIF
...
C     Read from e2Bufr1_RL(iBufr,sNb,sBi,sBj,sLv)
         ...
         e2Bufr1_RL(iLoc,sNb,sBi,sBj,sLv) = array1(itl,jtl,ktl)
         array1(itl,jtl,ktl) = 0.
        ENDDO
       ENDDO
      ENDDO
      IF ( iBufr1 .GT. e2BufrRecSize ) THEN
        WRITE(msgBuf,'(2A,I9,A,I9)') 'EXCH2_AD_GET_RL2:',
     &   ' iBufr1=', iBufr1, ' exceeds E2BUFR size=', e2BufrRecSize
        CALL PRINT_ERROR ( msgBuf, myThid )
        STOP 'ABNORMAL END: S/R EXCH2_AD_GET_RL2 (iBufr1 over limit)'
      ENDIF
...
C     Read from e2Bufr2_RL(iBufr,sNb,sBi,sBj,sLv)
         ...
         e2Bufr2_RL(iLoc,sNb,sBi,sBj,sLv) = array2(itl,jtl,ktl)
     ...
     &   ' iBufr2=', iBufr2, ' exceeds E2BUFR size=', e2BufrRecSize
        CALL PRINT_ERROR ( msgBuf, myThid )
        STOP 'ABNORMAL END: S/R EXCH2_AD_GET_RL2 (iBufr2 over limit)'
      ENDIF
