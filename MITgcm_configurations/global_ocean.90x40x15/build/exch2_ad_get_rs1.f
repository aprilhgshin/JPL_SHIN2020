...
CBOP 0
C !ROUTINE: EXCH2_AD_GET_RS1

C !INTERFACE:
      SUBROUTINE EXCH2_AD_GET_RS1(
...
C     sizeNb        :: Second dimension of e2Bufr1_RS
C     sizeBi        :: Third  dimension of e2Bufr1_RS
C     sizeBj        :: Fourth dimension of e2Bufr1_RS
...
C     myThid        :: my Thread Id. number
      ...
      INTEGER iBufr
      Real*8     e2Bufr1_RS( e2BufrRecSize, sizeNb, sizeBi, sizeBj, 2 )
      Real*8     array(i1Lo:i1Hi,j1Lo:j1Hi,k1Lo:k1Hi)
...
C      this source tile Id "soT" (note: this is saved in W2_tileIndex array)
      ...
      ELSEIF ( commSetting .EQ. 'M' ) THEN
       ...
       sNb = nN
      ELSE
       STOP 'EXCH2_AD_GET_RS1:: commSetting VALUE IS INVALID'
      ENDIF
...
C     Read from e2Bufr1_RS(iBufr,sNb,sBi,sBj,sLv)
         ...
         e2Bufr1_RS(iLoc,sNb,sBi,sBj,sLv) = array(itl,jtl,ktl)
         array(itl,jtl,ktl) =  0.
        ENDDO
       ENDDO
      ENDDO
      IF ( iBufr .GT. e2BufrRecSize ) THEN
        WRITE(msgBuf,'(2A,I9,A,I9)') 'EXCH2_AD_GET_RS1:',
     &   ' iBufr =', iBufr, ' exceeds E2BUFR size=', e2BufrRecSize
        CALL PRINT_ERROR ( msgBuf, myThid )
        STOP 'ABNORMAL END: S/R EXCH2_AD_GET_RS1 (iBufr over limit)'
      ENDIF
