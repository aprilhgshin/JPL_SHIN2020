...
CBOP
C     !ROUTINE: EXCH2_UV_DGRID_3D_R8

C     !INTERFACE:
      SUBROUTINE EXCH2_UV_DGRID_3D_R8(
     U                                 uPhi, vPhi,
     I                                 withSigns, myNz, myThid )

C     !DESCRIPTION:
C*=====================================================================*
C  Purpose: SUBROUTINE EXCH2_UV_DGRID_3D_R8
...
C
C  Calls: EXCH_R8 (EXCH2_R82_CUBE) ignoring sign
...
c      CALL EXCH2_R82_CUBE( vPhi, uPhi, .FALSE., 'Cg',
