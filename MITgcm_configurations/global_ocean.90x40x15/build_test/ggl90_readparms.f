...
C     Blanke and Delecluse (1993, JPO) use
      ...
      GGL90TKEmin          = 1.0D-11
C     Blanke and Delecluse (1993, JPO) use
      GGL90TKEsurfMin      = 1.0D-04
      GGL90TKEbottom       = UNSET_RL
      GGL90viscMax         = 1.D2
      GGL90diffMax         = 1.D2
      GGL90diffTKEh        = 0.0D0
      GGL90mixingLengthMin = 1.0D-08
      mxlMaxFlag           = 0
      mxlSurfFlag          = .FALSE.
      GGL90TKEFile         = ' '
...
C-----------------------------------------------------------------------
      IDEMIX_tau_v      =  1.0*86400.0D0
      IDEMIX_tau_h      = 10.0*86400.0D0
      IDEMIX_gamma      = 1.57D0
      IDEMIX_jstar      = 10.0D0
      IDEMIX_mu0        = 4.0D0/3.0D0
      IDEMIX_mixing_efficiency = 0.1666D0
      IDEMIX_diff_max   = 1.0D0
      IDEMIX_diff_min   = 1.0D-9
      IDEMIX_frac_F_b   = 1.0D0
      IDEMIX_frac_F_s   = 0.2D0
