...
CBOP
C     !ROUTINE: EXCH2_UV_DGRID_3D_RL

C     !INTERFACE:
      SUBROUTINE EXCH2_UV_DGRID_3D_RL(
     U                                 uPhi, vPhi,
     I                                 withSigns, myNz, myThid )

C     !DESCRIPTION:
C*=====================================================================*
C  Purpose: SUBROUTINE EXCH2_UV_DGRID_3D_RL
...
C
C  Calls: EXCH_RL (EXCH2_RL2_CUBE) ignoring sign
...
c      CALL EXCH2_RL2_CUBE( vPhi, uPhi, .FALSE., 'Cg',
