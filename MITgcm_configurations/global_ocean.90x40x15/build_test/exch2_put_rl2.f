...
CBOP 0
C !ROUTINE: EXCH2_PUT_RL2

C !INTERFACE:
      SUBROUTINE EXCH2_PUT_RL2 (
...
C     myThid        :: my Thread Id. number
      ...
      Real*8     e2Bufr1_RL( e2BufrRecSize )
      Real*8     e2Bufr2_RL( e2BufrRecSize )
...
C     Ran off end of buffer. This should not happen
     ...
     &   ' iBufr2=', iBufr2, ' exceeds E2BUFR size=', e2BufrRecSize
        CALL PRINT_ERROR ( msgBuf, myThid )
        STOP 'ABNORMAL END: S/R EXCH2_PUT_RL2 (iBufr2 over limit)'
      ENDIF
