...
CBOP
C     !ROUTINE: EXCH_R42_CUBE_AD

C     !INTERFACE:
      SUBROUTINE EXCH2_R42_CUBE_AD(
     U            array1, array2,
...
C     myThid      :: Thread number of this instance of S/R EXCH...
      ...
      Real*4 array1(1-myOLw:sNx+myOLe,
     &           1-myOLs:sNy+myOLn,
     &           myNz, nSx, nSy)
      Real*4 array2(1-myOLw:sNx+myOLe,
     &           1-myOLs:sNy+myOLn,
     &           myNz, nSx, nSy)
      LOGICAL signOption
