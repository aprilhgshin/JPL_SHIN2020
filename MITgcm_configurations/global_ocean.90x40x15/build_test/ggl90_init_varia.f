...
C-      3D arrays
        DO K=1,Nr
         ...
         DO J=1-OLy,sNy+OLy
          DO I=1-OLx,sNx+OLx
           GGL90viscArU(I,J,K,bi,bj) = 0.D0
           GGL90viscArV(I,J,K,bi,bj) = 0.D0
           GGL90diffKr(I,J,K,bi,bj)  = 0.D0
           IF ( useIDEMIX) THEN
            GGL90TKE(I,J,K,bi,bj)=GGL90eps*maskC(I,J,K,bi,bj)
           ELSE
CML           GGL90TKE(I,J,K,bi,bj)=0.D0
      ...
      DO bj = myByLo(myThid), myByHi(myThid)
       DO bi = myBxLo(myThid), myBxHi(myThid)
        ...
        DO K=1,Nr
         DO J=1-OLy,sNy+OLy
          DO I=1-OLx,sNx+OLx
           IDEMIX_E(I,J,K,bi,bj)     = 0.D0
           IDEMIX_V0(I,J,K,bi,bj)    = 0.D0
           IDEMIX_tau_d(I,J,K,bi,bj) = 0.D0
          ENDDO
         ENDDO
        ENDDO
        ...
        DO J=1-OLy,sNy+OLy
         DO I=1-OLx,sNx+OLx
          IDEMIX_F_B(I,J,bi,bj) = 0.D0
          IDEMIX_F_S(I,J,bi,bj) = 0.D0
         ENDDO
        ENDDO
      ...
      IF ( useIDEMIX .AND. IDEMIX_wind_file .NE. ' ' ) THEN
       ...
       DO bj = myByLo(myThid), myByHi(myThid)
        DO bi = myBxLo(myThid), myBxHi(myThid)
         DO J=1-OLy,sNy+OLy
          DO I=1-OLx,sNx+OLx
           IDEMIX_F_s(i,j,bi,bj) = MAX(0.D0,
     &          MIN(1.D0,IDEMIX_F_s(i,j,bi,bj)))
